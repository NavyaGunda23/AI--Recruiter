// src/components/VapiVoiceChat.tsx
...
const VapiVoiceChat: React.FC<VapiVoiceChatProps> = ({handleVapiChatClick}) => {
        ...
        <div>
            ...
            <div className='parnet-container'>
                ...
                <Typography  sx={{ fontSize:"14px",
                 left:0,color:"white",textAlign:"left",p:1,background:'linear-gradient(90deg, #6B73FF 0%, #3a6ea5 100%)',borderRadius:"10px" 
                }}>Call Reem <br /> to help you to create a job</Typography>
      <button
    ...
    {!isListening ? (
      ...
      <img src={dashboardIllustration1} alt="AI Recruiter" style={{ height: 200,position:"absolute",right:"0",zIndex:'-1' }} />
    </div>
        </div>
    );
};
